...
export default function Join() {
  return (
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      {/* HEADER */}
      <div style={{ paddingTop: '68px', backgroundColor: C.fog, padding: '9rem 5rem 6rem', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', right: '3rem', top: '50%', transform: 'translateY(-50%)', width: '280px', height: '280px', borderRadius: '50%', overflow: 'hidden', opacity: 0.07, pointerEvents: 'none' }}>
        ...
        <h1 style={{ fontFamily: D, fontStyle: 'italic', fontSize: 'clamp(3rem, 6vw, 5.5rem)', fontWeight: 400, lineHeight: 0.95, letterSpacing: '-0.03em', color: C.maroon, margin: '0 0 1.5rem', position: 'relative', zIndex: 1 }}>
      ...
      {/* TWO PATHWAYS */}
      <div role="region" className="join-panels" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '600px' }}>
        {/* Artisan Training */}
        <div className="join-panel-left" style={{ backgroundColor: C.maroonDeep, color: C.parchment, padding: '6rem 5rem', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <div>
            ...
            <p style={{ fontFamily: B, fontSize: '0.925rem', lineHeight: 1.85, opacity: 0.62, fontWeight: 300, maxWidth: '38ch', marginBottom: '2.5rem' }}>
          ...
          <button onClick={() => window.open('mailto:panchajanyaco05@gmail.com?subject=Artisan%20Training%20Application')} style={{ display: 'inline-block', fontFamily: B, fontSize: '0.8rem', letterSpacing: '0.1em', textTransform: 'uppercase', backgroundColor: C.parchment, color: C.maroon, padding: '1rem 1.5rem', border: 'none', cursor: 'pointer' }}>
            Apply for Artisan Training →
          </button>
        </div>

        {/* Delivery Partner */}
        <div className="join-panel-right" style={{ backgroundColor: C.maroon, color: C.parchment, padding: '6rem 5rem', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          <div>
      ...
      {/* FAQ */}
      <div role="region" style={{ padding: '8rem 5rem', backgroundColor: C.parchment }}>
        <div className="mob-1col" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6rem' }}>
          <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
            {[
              ...
              <details key={i} style={{ borderTop: `1px solid rgba(117,24,40,0.12)`, padding: '1.5rem 0' }}>
                ...
                <p style={{ fontFamily: B, fontSize: '0.9rem', lineHeight: 1.75, opacity: 0.62, fontWeight: 300, marginTop: '1rem', paddingRight: '2rem' }}>{a}</p>
              </details>
            ))}
      ...
      {/* FINAL CTA */}
      <div role="region" style={{ backgroundColor: C.maroonDeep, color: C.parchment, padding: '6rem 5rem', textAlign: 'center' }}>
        ...
        <p style={{ fontFamily: B, fontSize: '0.9rem', opacity: 0.55, marginBottom: '2rem', fontWeight: 300 }}>
          Write to us at panchajanyaco05@gmail.com or message on WhatsApp. We reply within a day.
        </p>
        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
          <button onClick={() => window.open('mailto:panchajanyaco05@gmail.com')} style={{ fontFamily: B, fontSize: '0.8rem', letterSpacing: '0.1em', textTransform: 'uppercase', backgroundColor: C.parchment, color: C.maroon, padding: '0.9rem 2rem', border: 'none', cursor: 'pointer' }}>
            Email Us
          </button>
          <Link to="/story" style={{ fontFamily: B, fontSize: '0.8rem', letterSpacing: '0.1em', textTransform: 'uppercase', border: '1px solid rgba(242,232,208,0.25)', color: C.parchment, padding: '0.9rem 2rem', textDecoration: 'none' }}>
            Our Story
          </Link>
        </div>
      </div>
