  ...
  return (
    <div style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ backgroundColor: C.fog, paddingTop: '68px', position: 'relative', overflow: 'hidden' }}>
        <div className="mob-1col" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '580px', alignItems: 'stretch' }}>
          {/* Left: text */}
          <div style={{ padding: '5rem 4rem 5rem 5.5rem', display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative', zIndex: 1 }}>
          ...
          {/* Right: auto slider */}
          <div style={{ position: 'relative', overflow: 'hidden', backgroundColor: C.sand, height: '100%' }}>
            {SLIDES.map((src, i) => (
              <img
                key={i}
                src={src}
      ...
      {/* MANIFESTO */}
      <div role="region" className="mob-section-lg" style={{ backgroundColor: C.maroon, color: C.parchment, padding: '6rem 5rem', textAlign: 'center' }}>
        <div style={{ width: '3rem', height: '1px', backgroundColor: C.sand, margin: '0 auto 3rem', opacity: 0.5 }} />
        <p style={{ fontFamily: D, fontStyle: 'italic', fontSize: 'clamp(2rem, 4vw, 4rem)', fontWeight: 300, lineHeight: 1.1, color: C.parchment, letterSpacing: '-0.03em', maxWidth: '22ch', margin: '0 auto' }}>
          "We didn't want charity. We wanted commerce. A dignified wage for dignified work."
        </p>
        <div style={{ width: '3rem', height: '1px', backgroundColor: C.sand, margin: '3rem auto', opacity: 0.5 }} />
      ...
      {/* ORIGIN STORY */}
      <div role="region" className="mob-1col" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '400px' }}>
        ...
        <div style={{ backgroundColor: C.parchment, padding: '5rem 4.5rem', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <h2 style={{ fontFamily: D, fontStyle: 'italic', fontSize: 'clamp(1.75rem, 3vw, 2.75rem)', fontWeight: 400, lineHeight: 1.1, letterSpacing: '-0.02em', color: C.maroon, marginBottom: '1.75rem' }}>
      ...
      {/* IMPACT STATS */}
      <div role="region" className="dot-grid mob-section-lg" style={{ backgroundColor: C.maroonDeep, color: C.parchment, padding: '6rem 5rem' }}>
        <p style={{ fontFamily: B, fontSize: '0.72rem', letterSpacing: '0.18em', textTransform: 'uppercase', color: C.sand, opacity: 0.7, marginBottom: '3rem', textAlign: 'center' }}>Impact in Numbers</p>
        <div className="mob-2col" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0', borderTop: '1px solid rgba(242,232,208,0.1)', borderBottom: '1px solid rgba(242,232,208,0.1)' }}>
          {[
            ...
            <div key={stat} style={{ padding: '3rem 2.5rem', borderLeft: i > 0 ? '1px solid rgba(242,232,208,0.1)' : 'none', textAlign: 'center' }}>
              <span style={{ fontFamily: D, fontStyle: 'italic', fontSize: '3.5rem', color: C.sand, display: 'block', lineHeight: 1, marginBottom: '0.75rem' }}>{stat}</span>
      ...
      {/* PROCESS */}
      <div role="region" className="dot-grid mob-section-lg" style={{ backgroundColor: C.maroonDeep, color: C.parchment, padding: '8rem 5rem', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="mob-2col" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0', position: 'relative' }}>
          <div style={{ position: 'absolute', top: '2.25rem', left: '12.5%', right: '12.5%', height: '1px', backgroundColor: 'rgba(212,187,138,0.2)' }} />
          {[
            ...
            <div key={title} style={{ paddingRight: i < 3 ? '2.5rem' : 0, position: 'relative', zIndex: 1 }}>
              <div style={{ width: '44px', height: '44px', borderRadius: '50%', border: `1px solid rgba(212,187,138,0.4)`, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '2rem', backgroundColor: C.maroonDeep }}>
      ...
      {/* CTA */}
      <div role="region" className="mob-section-lg" style={{ padding: '6rem 5rem', backgroundColor: C.fog, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: '2rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem' }}>
          <Link to="/shop" style={{ fontFamily: B, fontSize: '0.8rem', letterSpacing: '0.1em', textTransform: 'uppercase', backgroundColor: C.maroon, color: C.parchment, padding: '0.9rem 2rem', textDecoration: 'none' }}>Shop Now</Link>
          <Link to="/join" style={{ fontFamily: B, fontSize: '0.8rem', letterSpacing: '0.1em', textTransform: 'uppercase', border: `1px solid rgba(117,24,40,0.3)`, color: C.maroon, padding: '0.9rem 2rem', textDecoration: 'none' }}>Join the Programme</Link>
        </div>
      </div>
    </div>
  )
